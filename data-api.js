    ...
    const DataAPI = {
        ...
        _loadDefaultData() {
            const defaultData = {
                ...
                lecturers: [
                    { id: 1, name: "朱子墨", avatar: "https://p3-doubao-search-sign.byteimg.com/tos-cn-i-xv4ileqgde/49e48d5ec11e46789459aaa59464547a~tplv-be4g95zd3a-image.jpeg?lk3s=feb11e32", title: "资深前端工程师", level: "senior", levelName: "高级讲师", department: "技术部", skills: ["前端开发", "JavaScript", "React"], status: "enabled", courseCount: 12, rating: 4.9 },
